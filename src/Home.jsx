    ...
    return(
        <div className='home-container' id='home'>
            ...
            <div className='home-socials-links'>
                ...
                <a href='https://www.linkedin.com/in/maharshii-patel/overlay/1723693091214/single-media-viewer/?profileId=ACoAAEfcYbcBmzBI9wVEp8Jkhz6dw5y0jp3lZmk' rel='noopener' target='_blank'><img className='home-social-resume' src='https://www.pngitem.com/pimgs/m/495-4952625_resume-icon-black-and-white-png-download-resume.png'/></a>
            </div>
        </div>
    );
